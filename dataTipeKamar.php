    ...
    <section id="dataBarang">
        <div class="container">
            <div class="row text-center">
                <div class="col">
                    <h2 class="fw-normal mb-4">Data Tipe Kamar</h2>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $row["harga"]; ?></td>
                                    <td><?= $row["ket"]; ?></td>
                                    <td><a href="<?= "formTipeKamar.php?&&edit=update&&id=$row[id_tipe]"; ?>" class="btn btn-m btn-primary">Edit</a> |
                                        <a href="<?= "prosesTipeKamar.php?&&aksi=delete&&id=$row[id_tipe]"; ?>" class="btn btn-m btn-danger" onclick="javascript: return confirm('Apakah anda yakin ingin dihapus?')">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
