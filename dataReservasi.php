    ...
    <section id="dataBarang">
        <div class="container">
            <div class="row text-center">
                <div class="col">
                    <h2 class="fw-normal mb-4">Data</h2>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $row["no_hp"]; ?></td>
                                    <td><?= $row["email"]; ?></td>
                                    <td><a href="<?= "formReservasi.php?&&edit=update&&id=$row[id_reservasi]"; ?>" class="btn btn-m btn-primary">Edit</a> |
                                        <a href="<?= "prosesReservasi.php?&&aksi=delete&&id=$row[id_reservasi]"; ?>" class="btn btn-m btn-danger" onclick="javascript: return confirm('Apakah anda yakin ingin dihapus?')">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
