...
<body>
    ...
    <?php function UpdateTipeKamar()
    {
        $db = new database();
        $id = $_GET['id'];
        $row = $db->tampilUpdateTipeKamar($id);
    ?>

        <section id="ubahDataTipeKamar">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <form method="post" action="<?php echo 'prosesTipeKamar.php?aksi=update'; ?>" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label">Id Tipe Kamar</label>
                                <input type="text" name="id_tipe" class="form-control" value="<?= $row["id_tipe"] ?>" readonly>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Nama Tipe Kamar</label>
                                <input type="text" name="nama_tipe" class="form-control" value="<?= $row["nama_tipe"] ?> ">
                            </div>

                            <div class=" mb-3">
                                <label class="form-label">Fasilitas</label>
                                <textarea class="form-control" name="fasilitas" rows="3"><?= $row["fasilitas"] ?></textarea>
                            </div>
                            ...
                            <div class=" mb-3">
                                ...
                                <textarea class="form-control" name="ket" rows="3"><?= $row["ket"] ?></textarea>
                            </div>
    ...
    ?>
        ...
        <section id="tambahDataTipeKamar">
            <div class="container">
                <div class="row text-center">
                    <div class="col">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <form method="post" action="<?php echo 'prosesTipeKamar.php?aksi=tambah'; ?>" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label">Nama Tipe Kamar</label>
                                <input type="text" name="nama_tipe" class="form-control" placeholder="Masukkan Tipe Kamar">
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Harga</label>
                                <input type="text" name="harga" class="form-control" placeholder="Masukkan Harga Kamar">
                            </div>
