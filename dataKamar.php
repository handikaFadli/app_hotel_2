    ...
    <section id="dataBarang">
        <div class="container">
            <div class="row text-center">
                <div class="col">
                    <h2 class="fw-normal mb-4">Data Kamar</h2>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $row["maks"]; ?></td>
                                    <td><?= $row["desk"]; ?></td>
                                    <td><a href="<?= "formKamar.php?&&edit=update&&id=$row[id_kamar]"; ?>" class="btn btn-m btn-primary">Edit</a> |
                                        <a href="<?= "prosesKamar.php?&&aksi=delete&&id=$row[id_kamar]"; ?>" class="btn btn-m btn-danger" onclick="javascript: return confirm('Apakah anda yakin ingin dihapus?')">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
